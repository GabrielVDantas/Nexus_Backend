...
public class MailService {
    ...
    private String verifyUrl = "http://localhost:8080/account/verify?code=";

    public void sendVerificationCode(Account account) {

        var toAddress = account.getEmail();

        var fromAddress = "gvdantas2028@gmail.com";

        var senderName = "Nexus";

        var subject = "Nexus: Verifique seu e-mail";
        ...
        try {
            ...
            content = content.replace("[[NAME]]", account.getName());
            var verifyUrl = this.verifyUrl + account.getVerificationCode();
